...
@Component({
  selector: 'app-move-down-scan',
  templateUrl: './move-down-scan.component.html',
  styleUrls: ['./move-down-scan.component.css']
})
export class MoveDownScanComponent implements OnInit {
