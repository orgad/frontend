...
const routes: Routes = [
    ...
    { path: 'out/dn/details/:id', component: DnDetailsComponent },
    { path: 'out/dn/details/importdetail/:id', component: DnImportDetailComponent },
    { path: 'out/outbound', component: OutboundListComponent },
    { path: 'out/outbound/details/:id', component: OutboundDetailsComponent },
    { path: 'out/allot', component: AllotListComponent },
    { path: 'out/allot/details/:id', component: AllotDetailsComponent },
    { path: 'out/wave', component: WaveListComponent },
    { path: 'out/wave/details/:id', component: WaveDetailsComponent },
    { path: 'out/picking', component: PickListComponent },
    { path: 'out/picking/details/:id', component: PickDetailsComponent },
    { path: 'out/recheck', component: RechekListComponent },
    { path: 'out/express', component: ExpressListComponent },
    { path: 'out/recheck/details/:id', component: RechekDetailsComponent },
    { path: 'out/handOver', component: HandOverListComponent },
    { path: 'out/handOver/details/:id', component: HandOverDetailsComponent },
];
